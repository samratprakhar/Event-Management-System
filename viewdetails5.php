...
<html>
    <head>
        ...
        if(filter_has_var(INPUT_POST,'submit')){
          ...
          $mailid = $_POST['mailid'];
          $no = $_POST['no'];
          $event = 'NIT Delhi Convocation 2020';
        ...
        <div class = "content"><!--body content holder-->
            <div class = "container">
                <div class = "col-md-12"><!--body content title holder with 12 grid columns-->
                    <h1>NIT Delhi Convocation 2020</h1><!--body content title-->
                </div>
            ...
            <div class="container">
                <div class="col-md-6 contacts">
                    <p>
                    Description: <?php 
                                    $timeq="select Description from Events where Title = 'NIT Delhi Convocation 2020';";
            ...
            <br>
                        Time: <?php 
                                    $timeq="select StartTime,EndTime from Events where Title = 'NIT Delhi Convocation 2020';";
                                    $result = $conn->query($timeq);
                                    if ($result->num_rows > 0) {
                                        while($row = $result->fetch_assoc()) {
            ...
            <br>
                        Venue: <?php 
                                    $venue="select Name,Address from locations where LocationID = (select LocationID from Events where Title = 'NIT Delhi Convocation 2020');";
                        ...
                        <br>
                        Ticket Cost:  <?php 
                                    $cost="select Cost from Events where Title = 'NIT Delhi Convocation 2020';";
