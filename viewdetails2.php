        ...
        <div class = "content"><!--body content holder-->
            <div class = "container">
                <div class = "col-md-12"><!--body content title holder with 12 grid columns-->
                    <h1>Music Jam</h1><!--body content title-->
                </div>
            ...
            <div class="container">
                <div class="col-md-6 contacts">
                    <p>
                    Description: <?php 
                                    $timeq="select Description from Events where Title = 'Music Jam';";
            ...
            <br>
                        Time: <?php 
                                    $timeq="select StartTime,EndTime from Events where Title = 'Music Jam';";
                                    $result = $conn->query($timeq);
                                    if ($result->num_rows > 0) {
                                        while($row = $result->fetch_assoc()) {
            ...
            <br>
                        Venue: <?php 
                                    $venue="select Name,Address from locations where LocationID = (select LocationID from Events where Title = 'Music Jam');";
                        ...
                        <br>
                        Ticket Cost:  <?php 
                                    $cost="select Cost from Events where Title = 'Music Jam';";
