            ...
            <div class = "container">
                ...
                <form action="createEvent.php" method="POST" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="datetime-local" class="form-control" id="StartDate" name="StartDate" value="<?php echoValue($formdata, "StartDate")?>" /><!--input-->
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="datetime-local" class="form-control" id="EndDate" name="EndDate" value="<?php echoValue($formdata, "EndDate")?>" /><!--input-->
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="form-group">
                        <label for="file" class="col-md-2 control-label">Event Image</label><!--event description-->
                        <div class="col-md-5">
