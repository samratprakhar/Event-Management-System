...
class EventTableGateway {
    ...
    public function insert($p) {
        $sql = "INSERT INTO events(Title, Description, StartDate, EndDate, Cost, LocationID, Filename) VALUES (:Title, :Description, :StartDate, :EndDate, :Cost, :LocationID, :Filename)";
